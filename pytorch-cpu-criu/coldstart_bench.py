...
# --- 阶段 0: Python 解释器启动 ---
# 记录脚本第一行执行的时间（Python 解释器已启动，但还没 import torch）
...
# 计算各阶段耗时
python_startup_s = t_python_ready  # 从 epoch 到脚本开始，这个值本身无用
