#!/bin/bash
# 冷启动 vs CRIU Restore 端到端对比基准测试 (Podman 版)
...
# ---- 配置 ----
# 按实际环境修改以下路径
VENV_PYTHON="/home/yingjiaze/docker-criu-snapshot-exp/pytorch-cpu-podman-criu/.venv/bin/python"
SCRIPT_DIR="/home/yingjiaze/docker-criu-snapshot-exp/pytorch-cpu-podman-criu"
...
echo "============================================"
echo "  PyTorch 推理冷启动 vs CRIU Restore 对比测试 (Podman 版)"
echo "============================================"
echo ""
